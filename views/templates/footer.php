            <div class="sa-app__footer d-block d-md-flex">Stroyka Admin — eCommerce Dashboard Template © 2021<div class="m-auto"></div>
    ...
    <script src="<?=BASE_URL?>assets/js/stroyka.js"></script>
    <script src="<?=BASE_URL?>assets/js/custom.js"></script>
    <script>
        const base_url = "<?=BASE_URL?>";
    </script>
    <script src="<?=BASE_URL?>assets/js/modulos/agenda.js"></script>
</body>
</html>